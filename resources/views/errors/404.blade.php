...
<title>404 — Halaman Tidak Ditemukan · EduLearn</title>
...
.glow{position:fixed;pointer-events:none;border-radius:9999px;filter:blur(80px);}
</style>
</head>
<body>

<div class="grid-bg"></div>
<div class="glow" style="width:400px;height:400px;top:-100px;left:-100px;background:rgba(79,110,247,.07)"></div>
<div class="glow" style="width:300px;height:300px;bottom:-80px;right:-80px;background:rgba(79,110,247,.05)"></div>
...
<div class="relative z-10 flex-1 flex items-center justify-center px-6 py-16">
  <div class="text-center max-w-md w-full">
    ...
    {{-- Big 404 number --}}
    <div class="font-display font-bold leading-none mb-6 select-none"
      style="font-size:clamp(80px,18vw,140px);background:linear-gradient(135deg,var(--ac),var(--ac2));-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;">
      404
    </div>

    {{-- Icon --}}
    <div class="inline-flex items-center justify-center w-16 h-16 rounded-2xl mb-5 mx-auto text-2xl a-bg-lt a-text">
